<?php
	...
	class ubicacionController extends mainModel{
		...
		public function listarUbicacionControlador($pagina,$registros,$url,$busqueda){
		...
		/*----------  Ubicacionador eliminar foto usuario  ----------*/
		public function eliminarFotoUbicacionControlador(){
		...
		/*----------  Ubicacionador actualizar foto usuario  ----------*/
		public function actualizarFotoUbicacionControlador(){
		...
		/*----------  Ubicacionador registrar usuario  ----------*/
		...
		if($check_usuario->rowCount()==1){
			...
			if($check_usuario['login']==$login && password_verify($clave,$check_usuario['password'])){
				...
				$alerta=[
					...
					"texto"=>"Ubicacion o clave incorrectos al momento de validar",
					"icono"=>"error"
				];
				return json_encode($alerta);
				exit();
		...
		if($registrar_usuario->rowCount()==1){
			$alerta=[
				"tipo"=>"limpiar",
				"titulo"=>"Clave del Ubicacion registrado",
