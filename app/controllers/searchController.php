<?php
	...
	class searchController extends mainModel{
		...
		public function modulosBusquedaControlador($modulo){
			$listaModulos=[
				'categoriaList', 'clienteList','proveedorList', 'bancoList', 'modeloList', 'marcaList', 'companyList', 'userSearch', 'userList', 'controlSearch', 'controlList', 'ubicacionSearch', 'ubicacionList', 'cashierSearch', 'clientSearch', 'productoList','subcategoriaList', 'saleSearch', 'subcatList'];
