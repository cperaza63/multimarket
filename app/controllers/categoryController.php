<?php
	...
	class categoryController extends mainModel{
		...
		public function obtenerUnItemControlador($id){
			...
			a.categoria_foto FROM control a INNER JOIN control b ON (a.unidad = b.control_id)
		...
		public function eliminarCategoryControlador(){
		    ...
		    if($eliminarControl->rowCount()==1){
		    	...
		    	if(is_file("../views/fotos/control/".$datos['categoria_foto'])){
		            chmod("../views/fotos/control/".$datos['categoria_foto'],0777);
		            unlink("../views/fotos/control/".$datos['categoria_foto']);
		        }
		...
		public function eliminarFotoCategoryControlador(){
    		...
    		if(is_file($img_dir.$datos['categoria_foto'])){

		        chmod($img_dir.$datos['categoria_foto'],0777);

		        if(!unlink($img_dir.$datos['categoria_foto'])){
		            $alerta=[
						"tipo"=>"simple",
						"titulo"=>"Ocurrió un error inesperado",
