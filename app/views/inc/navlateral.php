        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                $actualCompanyController = new companyController();
                $empresasdelUsuario = $actualCompanyController->listarNegociosUsuarioControlador($user_id);
                ?>
                <!-- Dark Logo-->
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                                <i class="mdi mdi-speedometer"></i> <span data-key="t-dashboards">Administración</span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                                <i class="mdi mdi-view-grid-plus-outline"></i> <span data-key="t-apps">Aplicaciones</span>
                            </a>
                                ...
                                <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebarCalendar">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="apps-calendar.html" class="nav-link" data-key="t-main-calender"> Calendario Global</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="apps-calendar-month-grid.html" class="nav-link" data-key="t-month-grid"> Vista del mes </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                        <a href="apps-chat.html" class="nav-link" data-key="t-chat"> Correo interno </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarAuth">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo APP_URL."logOut/"; ?>" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLogout" data-key="t-logout"> Salir
                                        </a>
                                        <div class="collapse menu-dropdown" id="sidebarLogout">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="<?php echo APP_URL."logOut/"; ?>" class="nav-link" data-key="t-basic"> Basic </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="<?php echo APP_URL."logOut/"; ?>" class="nav-link" data-key="t-cover"> Cover </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <form class="app-search d-none d-md-block">
                    ...
                    <div class="mb-3">
                        <select name="company_actual" class="form-control" data-choices data-choices-text-unique-true id="company_actual">
                            <option value="">Conectado a <?=$_SESSION['company_name'];?></option>
                            <?php
                            print_r($empresasdelUsuario);
                            if (is_array($empresasdelUsuario)) {
                                foreach ($empresasdelUsuario as $empresadelUsuario) {
                                ?>
                                <option value="<?= $empresadelUsuario['company_id']; ?>" <?= $_SESSION['user_company_id'] == $empresadelUsuario['company_id'] ? "selected" : "" ?>><?= "Conectado a " . $empresadelUsuario['company_name']; ?>
                                </option>
                                <?php
                                }
                            }
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user mb-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="pages-profile-settings.html"><span class="badge bg-success-subtle text-success mt-1 float-end">New</span><i class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Configuración</span></a>
                        <a class="dropdown-item" href="auth-lockscreen-basic.html"><i class="mdi mdi-lock text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Lock screen</span></a>
                        <a class="dropdown-item" href="<?php echo APP_URL."logOut/"; ?>"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Cerrar Sesión</span></a>
                    </div>
                </div>
            </div>
        </div>
