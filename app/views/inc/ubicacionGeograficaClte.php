              	...
              	<form class="FormularioAjax" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            placeholder="latitude" value="<?=$datos['cliente_latitude'];?>">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="mb-3">
                            <input name="longitude" type="text" id="txtLng" class="form-control" 
                            placeholder="longitud" value="<?=$datos['cliente_longitude'];?>">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="mb-3">
...
<!--    <p><span class="col-md-2">
    ...
    <script>
        ...
        var map
            ...
            if (a== 1){
                a=0;
                    vMarker.setPosition(new google.maps.LatLng(<?=$datos['cliente_latitude'];?>, <?=$datos['cliente_longitude'];?>));
                    map.panTo(new google.maps.LatLng(<?=$datos['cliente_latitude'];?>, <?=$datos['cliente_longitude'];?>));
                    $("#txtLat").val(<?=$datos['cliente_latitude'];?>);
                    $("#txtLng").val(<?=$datos['cliente_longitude'];?>);
