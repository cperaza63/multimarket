...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <a href="<?php echo APP_URL; ?>clienteNew/" class="btn btn-success" >Agregar al Cliente</a>
            ...
            if(isset($_SESSION[$url[0]]) && !empty($_SESSION[$url[0]])){
                $datos = $insCliente->listarTodosClienteControlador($company_id, $_SESSION[$url[0]]);
            }else{
                $datos = $insCliente->listarTodosClienteControlador($company_id, "*");
            }
            ?>
            <div class="row">
                <div class="col-lg-12">
                                    ...
                                    if(is_array($datos)){
                                        foreach($datos as $rows){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= APP_URL.'clienteUpdate/'.$rows['cliente_id'].'/'?>">
                                                    <img class="rounded-circle header-profile-user" 
                                                    src="<?=$cliente_logo; ?>" 
                                                    alt="Logo del cliente de la tabla">
                                                    </a>
                                                </td>
                                                <td><?=$rows['cliente_name'];?></td>
                                                <td>
                                                    <div class="dropdown d-inline-block">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li><a href="<?= APP_URL.'clienteUpdate/'.$rows['cliente_id'].'/'?>" class="dropdown-item"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Editar</a></li>
                                                            <li>
                                                ...
                                                <td><?=$rows['cliente_id'];?></td>
                                                <td><?=$rows['cliente_email'];?></td>
                                                <td><?=$rows['cliente_phone'];?></td>
                                                <td><?=$rows['cliente_address'];?></td>
                                                <td>
                                                    <?php
                                                    if($rows['cliente_estatus'] ==1 ){
