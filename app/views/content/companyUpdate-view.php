                        ...
                        <div class="card mt-n6">
                            <div class="card-body p-1">
                                <div class="text-center">
                                    <form class="FormularioAjax" name="<?php echo $control_tipo; ?>" 
                            ...
                            <div class="card mt-xxl-n5">
                                <div class="card-header">
                                    <ul id="myTab" class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                        |<li class="nav-item">
                                            <a class="nav-link active" id="tab-header-1" 
                                            data-bs-toggle="tab" 
                                        ...
                                        <li li class="nav-item">
                                            <a class="nav-link" id="tab-header-2" 
                                            data-bs-toggle="tab" href="#multimedia" role="tab">
