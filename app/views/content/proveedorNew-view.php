                        ...
                        <div class="card mt-xxl-n5">
                            ...
                            <div class="card-body p-4">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="proveedorDetalis" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label for="proveedor_name" class="form-label">Nombre Tienda/negocio</label>
                                                    <input name="proveedor_name" type="text" class="form-control" 
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3 pb-2">
                                                    ...
                                                    <textarea name="proveedor_description" class="form-control" 
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3 pb-2">
                                                    ...
                                                    <textarea name="proveedor_address" class="form-control" 
                                                    id="exampleFormControlTextarea" 
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    if(is_array($paises)){
                                                        foreach($paises as $pais){
                                                            ?>
                                                                <select name="proveedor_country" class="form-control" 
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label for="proveedor_email" class="form-label">Email del negocio</label>
                                                    <input name="proveedor_email" type="email" class="form-control" 
                                                    id="proveedor_email" placeholder="Email del Proveedor" required 
                                                    />
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="proveedor_phone" type="number" class="form-control" 
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="proveedor_rif" type="text" class="form-control" 
                                            ...
                                            <div class="col-lg-2">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="proveedor_estatus" class="form-control" required 
                                            ...
                                            <div class="col-lg-12">
                                                <div class="hstack gap-2 justify-content-end">
                                                    <button type="submit" class="btn btn-primary">Agregar el Proveedor</button>
                                                    <a href="<?php echo APP_URL; ?>proveedorList/" 
