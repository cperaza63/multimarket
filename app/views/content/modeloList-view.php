    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            if (isset($_SESSION['view'])) {
                ...
                echo "Error, no hay parámetro de marca";
            }
            use app\controllers\marcaController;
            $insMarca = new marcaController();
            $datos_marca = $insMarca->obtenerUnItemControlador($marca);
            use app\controllers\modeloController;
            $insModelo = new modeloController();
            ?>
            <div class="row">
                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <a href="<?php echo APP_URL; ?>modeloNew/<?= $marca ?>" class="btn btn-success">Agregar Modelos a <?= $datos_marca['nombre'] ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
            ...
            <?php
            if (isset($_SESSION[$url[0]]) && !empty($_SESSION[$url[0]])) {
                $datos = $insModelo->listarTodosmodeloControlador($marca, $_SESSION[$url[0]]);
            } else {
                $datos = $insModelo->listarTodosmodeloControlador($marca, "*");
            }
            ?>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                            <div class="hstack gap-2 justify-content-end">
                                <a href="<?php echo APP_URL; ?>marcaList/" class="btn btn-soft-success">Regresar</a>
                            </div>
                        </div>
                        <div class="card-header">
                            <h5 class="card-title mb-0">Lista de Modelos de <?= $datos_marca['nombre'] ?></h5>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= APP_URL . 'modeloUpdate/' . $rows['marca_id'] . '/' ?>">
                                                        <img class="rounded-circle header-profile-user" src="<?= $marca_foto; ?>" 
                                                ...
                                                <td>
                                                    <div class="dropdown d-inline-block">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li>
                                                                <a href="<?= APP_URL . 'modeloUpdate/' . $rows['marca_id'] . '/' ?>" class="dropdown-item"><i class="ri-pencil-fill align-bottom me-2 text-muted">
                                                                    </i> Editar</a>
                                                            </li>
                                                            <li>
                                                                <form class="FormularioAjax" action="<?= APP_URL ?>app/ajax/modeloAjax.php" method="POST" autocomplete="off">
                                                                    <input type="hidden" name="modulo_modelo" value="eliminar">
