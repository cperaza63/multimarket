                                    ...
                                    method="POST" autocomplete="off" enctype="multipart/form-data">
                                        ...
                                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                            ...
                                            echo $proveedor_logo == "nophoto.jpg"
                                                ...
                                                : "http://localhost/multimarket/app/views/fotos/company/$company_id/proveedores/" . $proveedor_logo;
                                                    ...
                                                    <div class="text-center">
                                                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                                            <img src="<?php echo $proveedor_card == "nophoto.jpg"
                                                                            ? "http://localhost/multimarket/app/views/fotos/nophoto.jpg"
                                                                            : "http://localhost/multimarket/app/views/fotos/company/$company_id/proveedores/".$proveedor_card;
                                                ...
                                                <div class="card-body p-1">
                                                    <div class="text-center">
                                                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                                            <img src="<?php echo $proveedor_card == "nophoto.jpg"
                                                                            ? "http://localhost/multimarket/app/views/fotos/nophoto.jpg"
                                                                            : "http://localhost/multimarket/app/views/fotos/company/$company_id/proveedores/".$proveedor_banner1;
                                                                        ?>" class="rounded avatar-xl img-thumbnail user-profile-image  shadow" alt="user-profile-image">
                                                            <div class="avatar-xs p-0 rounded-circle ">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                                            ...
                                                            <img src="<?php echo $proveedor_banner2 == "nophoto.jpg"
                                                                            ? "http://localhost/multimarket/app/views/fotos/nophoto.jpg"
                                                                            : "http://localhost/multimarket/app/views/fotos/company/$company_id/proveedores/". $proveedor_banner2;
                                                                        ?>" class="rounded avatar-xl img-thumbnail user-profile-image  shadow" alt="user-profile-image">
                                                            <div class="avatar-xs p-0 rounded-circle ">
                                                    ...
                                                    <div class="text-center">
                                                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                                            <img src="<?php echo $proveedor_banner3 == "nophoto.jpg"
                                                                            ? "http://localhost/multimarket/app/views/fotos/nophoto.jpg"
                                                                            : "http://localhost/multimarket/app/views/fotos/company/$company_id/proveedores/".$proveedor_banner3;
                                                                        ?>" class="rounded avatar-xl img-thumbnail user-profile-image  shadow" alt="user-profile-image">
                                                            <div class="avatar-xs p-0 rounded-circle ">
