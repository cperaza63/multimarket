                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <a href="<?php echo APP_URL; ?>categoryNew/" class="btn btn-success" >Agregar Categoría</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                    ...
                                    if(is_array($datos)){
                                        foreach($datos as $rows){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= APP_URL.'categoryUpdate/'.$rows['categoria_id'].'/'?>">
                                                ...
                                                <td>
                                                    <div class="dropdown d-inline-block">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <li>
                                                                <form class="FormularioAjax" action="<?=APP_URL?>app/ajax/categoryAjax.php" 
                                                                method="POST" autocomplete="off" >
                                                                    <input type="hidden" name="modulo_category" value="eliminar">
